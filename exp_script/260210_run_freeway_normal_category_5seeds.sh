...
if [ "$1" != "--running" ]; then
    MASTER_LOG="log/freeway_normal_category_$(date '+%y%m%d%H%M').log"
    mkdir -p log
    nohup "$0" --running > "$MASTER_LOG" 2>&1 &
    PID=$!
    echo "=========================================="
    echo "Freeway: NormalCategory (5 seeds)"
    echo "  PID: $PID"
    echo "  Master log: $MASTER_LOG"
    echo "=========================================="
    echo ""
    echo "Experiments (5 total):"
    echo "  NormalCategory baseline: seed 0-4"
    echo ""
    echo "Common settings:"
    echo "  - dyn.rssm.dist: normal_category"
...
echo "=========================================="
echo "Starting Freeway: NormalCategory experiments"
...
###############################################################################
# NormalCategory実験 (dormant + normal_category) - 5 seeds
###############################################################################
for SEED in 0 1 2 3 4; do
    EXP_COUNT=$((EXP_COUNT + 1))
    EXP_NAME="normal_category_seed${SEED}"
    ...
    python dreamerv3/main.py \
        ...
        --logdir ${LOG_DIR} \
        --seed ${SEED} \
        --agent.dyn.rssm.dist normal_category \
...
echo "Total: 5 experiments (5 normal_category)"
echo "=========================================="
