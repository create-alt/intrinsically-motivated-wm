...
if [ "$1" != "--running" ]; then
    MASTER_LOG="log/trendmix_exp07_5games_$(date '+%y%m%d%H%M').log"
    mkdir -p log
    nohup "$0" --running > "$MASTER_LOG" 2>&1 &
    PID=$!
    echo "=========================================="
    echo "TrendMixture exp07: 5 experiments started in background"
    echo "  PID: $PID"
    echo "  Master log: $MASTER_LOG"
    echo "=========================================="
    echo ""
    echo "Experiments:"
    echo "  1. Bank Heist - trendmix_exp07"
    echo "  2. Frostbite - trendmix_exp07"
    echo "  3. Hero - trendmix_exp07"
    echo "  4. Seaquest - trendmix_exp07"
    echo "  5. Ms Pacman - trendmix_exp07"
    echo ""
    echo "exp07 settings:"
...
echo "=========================================="
echo "Starting TrendMixture exp07 experiments (5 games)"
...
###############################################################################
# 実験1: Bank Heist - trendmix_exp07
###############################################################################
TASK="bank_heist"
EXP_NAME="trendmix_exp07"
...
###############################################################################
echo "=========================================="
echo "All TrendMixture exp07 experiments completed at: $(date)"
echo "=========================================="
