...
if [ "$1" != "--running" ]; then
    MASTER_LOG="log/mspacman_recency_$(date '+%y%m%d%H%M').log"
    mkdir -p log
    nohup "$0" --running > "$MASTER_LOG" 2>&1 &
    PID=$!
    echo "=========================================="
    echo "Ms Pacman: Recency Sampling (5 seeds)"
    echo "  PID: $PID"
    echo "  Master log: $MASTER_LOG"
    echo "=========================================="
    echo ""
    echo "Experiments (5 total):"
    echo "  Recency sampling: seed 0-4"
    echo ""
    ...
    echo "  - replay.recexp: 1.0 (default)"
    echo ""
...
echo "=========================================="
echo "Starting Ms Pacman: Recency Sampling experiments"
...
echo "Total: 5 experiments (recency sampling)"
echo "=========================================="
